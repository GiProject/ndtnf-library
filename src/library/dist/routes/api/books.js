...
router.get('/:id/download', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, book, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                book = _a.sent();
                if (book) {
                    res.download(path_1.default.join(__dirname, "../..", book.fileName), function (err) {
                        if (err) {
...
router.post('/', file_1.default.single("fileBook"), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, description, authors, favorite, fileCover, fileName, file, fileBook, book;
...
router.put('/:id', file_1.default.single("fileBook"), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, title, description, authors, favorite, fileCover, fileName, file, fileBook, book;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
